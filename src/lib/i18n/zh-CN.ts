...
export const zhCnMessages = {
  ...
  deals: {
    seoTitle: 'Steam 游戏折扣与历史最低价 | GGEMU',
    title: '热门游戏折扣',
    description:
      '发现 Steam 当前精选折扣，查看游戏现价、折扣比例与历史最低价，找到值得入手的特价游戏。',
    eyebrow: '正在打折',
    regionLabel: '区域与货币',
    regionUs: '美国',
    regionJp: '日本',
    ...
    viewDetails: '查看游戏详情',
    backToDeals: '返回游戏折扣',
    detailSeoTitle: '{name} Steam 折扣、现价与历史最低 | GGEMU',
    detailSeoDescription:
      '{name} Steam 现价 {price}，优惠 {discount}%，历史最低 {historicalLow}。查看游戏介绍、截图、发行商与支持平台。',
    overview: '游戏简介',
    gameInfo: '游戏信息',
    developer: '开发商',
    publisher: '发行商',
    ...
    noData: '暂无',
    empty: '暂时没有可展示的游戏折扣，请稍后再试。',
    attribution: '折扣与价格数据来源：',
  },
  home: {
    title: '在线游玩经典复古游戏',
    subtitle:
